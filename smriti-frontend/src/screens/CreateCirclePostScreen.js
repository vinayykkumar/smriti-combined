/**
 * CreateCirclePostScreen
 * Create a new post specifically for a circle
 * Similar to CreatePostScreen but posts to a specific circle
 */
...
import { createCirclePost } from '../services/api/posts';

const { width } = Dimensions.get('window');

export default function CreateCirclePostScreen({ route, navigation }) {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerTitle: `Post to ${circleName}`,
    });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await createCirclePost(postData);

      if (result.success) {
        // Go back to the circle feed
        navigation.goBack();
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          style={[styles.shareButton, (!title.trim() && !description.trim()) && styles.disabledButton]}
          onPress={handleSave}
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.privacyNotice}>
            ...
            <Text style={styles.privacyText}>
              Only members of "{circleName}" will see this post
            </Text>
          </View>
